...
router.get('/me', verifyToken, requireRole(ROLES.VOLUNTEER, ROLES.STAFF, ROLES.ADMIN), async (req, res) => {
  try {
...
router.put('/me', verifyToken, requireRole(ROLES.VOLUNTEER, ROLES.STAFF, ROLES.ADMIN), async (req, res) => {
  try {
...
router.post('/claim/:reportId', verifyToken, requireRole(ROLES.VOLUNTEER, ROLES.STAFF, ROLES.ADMIN), async (req, res) => {
  try {
    ...
    // Check if report is in a claimable status
